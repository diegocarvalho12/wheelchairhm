% Fa�a na linha de comando: Sensor = VirtualRangefinder3(PoseRobo , Mapa)
% PoseRobo: estrutura com [x,y] em mil�metros e [th] em graus.
% Exemplo: PoseRobo.x = 1000; PoseRobo.y = 1200; PoseRobo.th = 45;
% Mapa: um dos mapas dispon�veis, de 1 a 6.
...
switch nargin
    ...
    otherwise
        error('A posicao do robo no formato de estrutura (structure), exemplo, PoseRobo.x = 0; PoseRobo.y = 0; PoseRobo.th = 0; com [x,y] em milimetros e [th] em graus. Insira um numero de mapa de 1 a 4.')
end
...
PoseReal.x  = PoseRobo.x;  %+ 20 * randn;
PoseReal.y  = PoseRobo.y;  %+ 20 * randn;
...
title(sprintf('Robo_x = %.2f mm, Robo_y = %.2f mm, Robo_{th} = %.2f graus\nMapa = %i' , PoseReal.x , PoseReal.y , PoseReal.th , Mapa))
drawnow
end
