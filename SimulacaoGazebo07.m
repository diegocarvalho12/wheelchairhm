...
% 5) Abrir o simulador (gazebo)
% 6) digite: roslaunch p3dx_gazebo gazebo.launch
...
% Inicializacao do ROS - utilizar quando inicializar o ROS
% rosinit('192.168.0.1
    % atribuir as velocidades corretas de acordo com a classe. Vale lembrar50','Nodehost','192.168.0.150','NodeName','/matlab1');
